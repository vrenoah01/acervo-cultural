...
* [ ] **ID 16 - Utiliza boas práticas de versionamento** no [Git](https://moodle.utfpr.edu.br/mod/url/view.php?id=1514436 "Git")/[GitHub](https://moodle.utfpr.edu.br/mod/url/view.php?id=2050195 "GitHub") (branch main ou branches específicos, uso de .gitignore).
